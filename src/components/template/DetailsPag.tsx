...
const DetailsPag = ({ Message , dashboard  } : DetailsPageProps ) => {
    ...
    return (
        <div className=" container w-full rounded-xl py-3" >
            ...
            <div className="flex py-4 gap-x-4 items-center justify-center" >
                <button onClick={copyHandler} className=' text-[#023e8a] bg-[#48cae4] md:px-8 text-sm md:font-bold md:text-base   px-3 py-1 rounded-md ' >Copy</button>
                {
                    dashboard ? 
                        <div className="flex gap-x-4 items-center justify-center">
                            <Link className=' text-[#1b4332] bg-[#95d5b2] md:px-8 text-sm md:font-bold md:text-base   px-3 py-1 rounded-md ' href={`/dashboard/my-advertisments/${_id}/edite`} >Edite</Link>
